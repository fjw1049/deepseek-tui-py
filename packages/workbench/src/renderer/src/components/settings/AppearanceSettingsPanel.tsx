        ...
        <Row
          ...
          control={
            <SegmentedControl
              ...
              onChange={(value) => onAppearancePatch({ uiDensity: value as UiDensity })}
            />
          }
        />
        <Row
...
function SegmentedControl({
  ...
  return (
    <div className="inline-flex rounded-xl border border-ds-border bg-ds-main/45 p-0.5 shadow-sm">
      {options.map((option) => {
        ...
        return (
          <button
            ...
            className={`rounded-[10px] px-3 py-1.5 text-[13px] font-medium transition ${
              active
