    ...
    <div className="px-4 py-5">
      ...
      {!error && usage && buckets.length > 0 ? (
        <>
          ...
          <div className="mt-4 max-h-[min(420px,50vh)] space-y-1.5 overflow-y-auto pb-3 pr-1">
            ...
            return (
              ...
              >
                <div className="flex items-center justify-between gap-3">
                  ...
                  <span className="shrink-0 text-[11.5px] tabular-nums text-ds-muted">
                    {formatCompactNumber(bucket.totalTokens)} tokens
                  </span>
                </div>
                <div className="mt-1 h-1.5 overflow-hidden rounded-full bg-ds-border">
                  <span
                    className="block h-full rounded-full"
                    style={{ width: `${widthPct}%`, backgroundColor: color }}
                  />
                </div>
                <div className="mt-1 flex flex-wrap items-center gap-x-2 text-[11px] tabular-nums text-ds-faint">
                  <span>
                    {t('modelUsageInOut', {
