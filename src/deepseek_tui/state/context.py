"""File context expansion for @mentions and attachments.

Consolidates the former context/types.py and context/file_context.py.
"""
...
# ============================================================================
# File context expansion (formerly context/file_context.py)
# ============================================================================
...
def _resolve_mention(token: str, workspace: Path, cwd: Path) -> tuple[Path, str] | None:
...
def _text_inclusion_mode(size: int, cfg: ContextConfig, total_inlined: int) -> str:
