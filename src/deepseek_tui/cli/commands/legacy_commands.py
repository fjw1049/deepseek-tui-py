"""CLI command registration — split from the former monolithic app module."""
...
from deepseek_tui.cli.config_io import cli_config_write, config_get_value
from deepseek_tui.cli.options import (
    API_KEY_OPTION,
...
from deepseek_tui.cli.runtime import launch_tui as _launch_tui, run_one_shot as _run_one_shot
...
def register_commands(app: typer.Typer) -> None:
    ...
    def config_get(
        ...
        loaded = _load_config(config, profile)
        value = config_get_value(loaded, key)
    ...
    def mcp_server(workspace: Path | None = MCP_WORKSPACE_OPTION) -> None:
